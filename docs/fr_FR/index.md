...
> **Tip**
>
> Le plugin marche sur un système de crédit, 1 SMS  = 1 crédit pour la France sinon 2 crédit, 1 appel =
> 2 crédits pour la France sinon 4 crédit. Vous pouvez consulter votre crédit
